...
public:
	...
	void classify(ImageRepresentation* image, ImageRepresentation* BGMRep, Patches* patches);
	void myupdate(ImageRepresentation* image, ImageRepresentation* BGMRep, Patches* patches, Rect tracked);
