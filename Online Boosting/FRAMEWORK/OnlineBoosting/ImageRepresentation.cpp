...
__int32 ImageRepresentation::getSum(Rect imageROI)
{
	...
	if ( (OriginX+Width  >= m_ROI.width) && (m_ROI.width-OriginX > 0) ) Width  = m_ROI.width  - OriginX;
	if ( (OriginY+Height >= m_ROI.height) && (m_ROI.height-OriginY > 0) ) Height = m_ROI.height  - OriginY;
