...
void BoostingTracker::classify(ImageRepresentation* image, Patches* patches)
{
...
void BoostingTracker::update(ImageRepresentation* image, Patches* patches, Rect tracked)
{
